...
function ProfilePageClient({
    ...
    const handleFollow = async () => {
        if (!currentUser) {
            toast.error("You need to be signed in to follow people.");
            return;
        }
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-1 gap-6">
                ...
                <Tabs defaultValue="posts" className="w-full gap-x-2">
                    <TabsList className="w-full justify-start rounded-none h-auto p-0 bg-transparent">
                        <TabsTrigger
                            value="posts"
                            className="flex items-center gap-2 rounded-sm data-[state=active]:border-b-2 data-[state=active]:border-primary
